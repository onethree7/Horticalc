...
SOLVER_CONFIG_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    {"key": "stage_optimization_enabled", "type": "boolean", "default": False},
    {"key": "stage_regression_pp", "type": "number", "default": 5.0},
    {"key": "stage_regression_mg_l", "type": "number", "default": 2.0},
    {"key": "macro_priority_enabled", "type": "boolean", "default": False},
