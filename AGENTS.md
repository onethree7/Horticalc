...
### Task 5 — GitHub Actions CI build & release artifacts [DONE.]
Scope:
...
- 2026-01-28: Aligned fertilizer selection and calculator table column widths with the PR74 layout for consistent alignment.
