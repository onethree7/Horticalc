...
export const FALLBACK_SOLVER_CONFIG_DEFINITIONS = [
  ...
  { key: "overshoot_penalty", type: "number", defaultValue: 1 },
  { key: "irls_max_outer_iter", type: "integer", defaultValue: 4 },
  { key: "scale_eps_mg_per_l", type: "number", defaultValue: 1 },
  ...
  { key: "n_total_governor_weight", type: "number", defaultValue: 1 },
];
