...
def test_nitrogen_objective_mode_n_total_only_excludes_forms() -> None:
    ...
    recipe = {
        ...
        "targets": {"N_total": 10.0, "N_NO3": 10.0, "N_NH4": 0.0, "N_UREA": 0.0},
        "fertilizers_allowed": ["NO3-only"],
        "solver_config": {"solver_model": "legacy", "nitrogen_objective_mode": "n_total_only"},
    }
...
def test_nitrogen_objective_mode_n_forms_only_excludes_total_and_keeps_zero_forms() -> None:
    ...
    recipe = {
        ...
        "targets": {"N_total": 10.0, "N_NO3": 10.0, "N_NH4": 0.0, "N_UREA": 0.0},
        "fertilizers_allowed": ["NO3-only"],
        "solver_config": {"solver_model": "legacy", "nitrogen_objective_mode": "n_forms_only"},
    }
...
def test_nitrogen_objective_mode_rejects_unknown_value() -> None:
    ...
    recipe = {
        ...
        "fertilizers_allowed": ["NO3-only"],
        "solver_config": {"solver_model": "legacy", "nitrogen_objective_mode": "chaos_mode"},
    }
...
def test_s_target_is_ignored_by_default_in_legacy_model() -> None:
    molar_masses = load_molar_masses()
    ferts = {
    ...
    recipe = {
        ...
        "solver_config": {"solver_model": "legacy"},
    }
...
def test_s_target_can_be_enabled_as_solver_objective() -> None:
    ...
    recipe = {
        ...
        "solver_config": {"solver_model": "legacy", "s_objective_enabled": True},
    }
