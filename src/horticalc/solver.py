...
def solve_recipe_data(
    ...
    *,
    ...
    stage_regression_pp = float(solver_config.get("stage_regression_pp", 1.0))
    stage_regression_mg_l = float(solver_config.get("stage_regression_mg_l", 1.0))
        ...
        *,
        ...
        for stage_group in stage_groups:
            ...
            if singleton_supplier_enabled:
                ...
                if np.any(np.abs(x_full_updated - x_full_local) > 1e-12):
